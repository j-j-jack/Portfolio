...
const Landing = () => {
  ...
  useEffect(() => {
    ...
    useEffect(() => {
      let colors = ['green', 'white-two', 'yellow', 'green', 'green', 'white-two', 'yellow', 'yellow'];
  ...
  <g>
    ...
    <g style={{"mixBlendMode":"normal"}}>
      <use ref={jRef} className="j animate__animated logo-letter" xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#s-Path_1-d1224" fill="var(--glitch-black)" fillOpacity="1.0"></use>
    </g>
  </g>
  <g>
    <defs>
    ...
    <g style={{"mixBlendMode":"normal"}}>
      <use ref={sRef} className="animate__animated logo-letter" xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#s-Path_3-d1224" fill="var(--glitch-black)" fillOpacity="1.0"></use>
    </g>
  </g>
  </g>
</svg>
